  ...
  return (
    <>
      <header className="top-bar-wrapper">
        ...
        >
          ...
          >
                  ...
                  <ListItem key={index}>
                    <ListItemButton>
                      ...
                      >
                        {val.icon}
                        <span className="text">
                          {i18n[val.text as keyof typeof i18n]}
                        </span>
                      </Button>
                    </ListItemButton>
                  </ListItem>
            ...
            <div className="bottom-menu">
              ...
              <List>
                {user.schools?.map(
                  (val: { schoolId: number; schoolName: string }, index) => (
                    <ListItem key={index}>
        ...
        <span className="name">
          {user.schools?.filter((val) => val.schoolId === user.currSchoolId)[0]
            ?.schoolName || ""}
        </span>
        ...
        >
          {user.unreadGps > 0 ? (
            <>
              <Typography className="unread-gps-counter">
                {user.unreadGps}
              </Typography>
