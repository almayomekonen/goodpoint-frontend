...
export const Login = () => {
  ...
  async function loginFunc(values: LoginFormValues) {
    ...
    const { msg } = await login(`${baseURL}/api/staff/login`, {
      ...
      <div className="inputs-container">
        {!forgetPassword ? (
          <>
            ...
            >
              <FormTextInput
                placeholder={i18n.loginText.mail}
                name="username"
                maxLength={40}
              />
              <FormPassword
                placeholder={i18n.loginText.password}
                name="password"
                maxLength={20}
              />
              <Button
              ...
              <FormSubmitButton
                className={clsx(
                  desktop ? "login-button-desktop" : "login-button"
                )}
              >
          ...
          <>
            ...
            >
              <FormTextInput
                placeholder={i18n.loginText.enterEmail}
                name="email"
                maxLength={40}
              />
              <FormSubmitButton
